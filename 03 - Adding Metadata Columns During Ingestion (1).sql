...
-- MAGIC       .load("/Volumes/dbacademy_ecommerce/v01/raw/user_historical")
-- MAGIC     )
-- MAGIC
-- MAGIC
...
-- MAGIC  .saveAsTable(f"dbacademy.labuser101.historical_users_bronze_python_metadata")
-- MAGIC )
-- MAGIC
-- MAGIC
-- MAGIC # 4. Read and display the table
-- MAGIC historical_users_bronze_python_metadata = spark.table(f"dbacademy.labuser101.historical_users_bronze_python_metadata")
-- MAGIC
